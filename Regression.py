...
class Regression( unittest.TestCase ):
    ...
    def test_RegressionDa2(self):
        ...
        self.navigator.selectCasePage().selectCasesSubmit().tap()
        self.navigator.addTestPlanPage().renamePlanTitle( "1" ).tap()
        self.navigator.addTestPlanPage().editPlanName( "Galaxy S6 edge (7.0)", "500 Plan", "R-C", "Release", "Stg", "Release" )
        self.navigator.addTestPlanPage().editConfirm().tap()
        self.navigator.addTestPlanPage().renamePlanTitle( "2" ).tap()
        self.navigator.addTestPlanPage().editPlanName( "Galaxy S7 Edge (8.0)", "SpP Plan", "R-C", "Release", "Stg", "Release" )
        self.navigator.addTestPlanPage().editConfirm().tap()
        self.navigator.addTestPlanPage().renamePlanTitle( "3" ).tap()
        self.navigator.addTestPlanPage().editPlanName( "Galaxy S8 (9.0)", "HighTier Plan", "R-C", "Release", "Stg","Release" )
        self.navigator.addTestPlanPage().editConfirm().tap()
        self.navigator.addTestPlanPage().acceptTestCasePaln().tap()
    ...
    def test_RegressionDay1_iOS(self):
        ...
        self.navigator.selectCasePage().selectCasesSubmit().tap()
        self.navigator.addTestPlanPage().renamePlanTitle( "1" ).tap()
        self.navigator.addTestPlanPage().editPlanName( "iPhone 12.x 系列", "500 Plan", "F-C", "Release", "Stg", "Release" )
        self.navigator.addTestPlanPage().editConfirm().tap()
        self.navigator.addTestPlanPage().renamePlanTitle( "2" ).tap()
        self.navigator.addTestPlanPage().editPlanName( "iPhone 13.x 系列", "SpP Plan", "F-C", "Release", "Stg", "Release" )
        self.navigator.addTestPlanPage().editConfirm().tap()
        self.navigator.addTestPlanPage().renamePlanTitle( "3" ).tap()
        self.navigator.addTestPlanPage().editPlanName( "iPhone 11.x 系列", "HighTier Plan", "F-C", "Release", "Stg", "Release" )
        self.navigator.addTestPlanPage().editConfirm().tap()
        self.navigator.addTestPlanPage().acceptTestCasePaln().tap()
    ...
    def test_RegressionDay2_iOS(self):
        ...
        self.navigator.selectCasePage().selectCasesSubmit().tap()
        self.navigator.addTestPlanPage().renamePlanTitle( "1" ).tap()
        self.navigator.addTestPlanPage().editPlanName( "iPhone 12.x 系列", "500 Plan", "R-C", "Release", "Stg", "Release" )
        self.navigator.addTestPlanPage().editConfirm().tap()
        self.navigator.addTestPlanPage().renamePlanTitle( "2" ).tap()
        self.navigator.addTestPlanPage().editPlanName( "iPhone 13.x 系列", "SpP Plan", "R-C", "Release", "Stg", "Release" )
        self.navigator.addTestPlanPage().editConfirm().tap()
        self.navigator.addTestPlanPage().renamePlanTitle( "3" ).tap()
        self.navigator.addTestPlanPage().editPlanName( "iPhone 11.x 系列", "HighTier Plan", "R-C", "Release", "Stg","Release" )
        self.navigator.addTestPlanPage().editConfirm().tap()
        self.navigator.addTestPlanPage().acceptTestCasePaln().tap()
    ...
    def test_FinalCheck_iOS(self):
        ...
        self.navigator.selectCasePage().selectCasesSubmit().tap()
        self.navigator.addTestPlanPage().renamePlanTitle( "1" ).tap()
        self.navigator.addTestPlanPage().editPlanName( "iPhone 12.x 系列", "500 Plan", "AT", "Master", "Prod", "Master" )
        self.navigator.addTestPlanPage().editConfirm().tap()
        self.navigator.addTestPlanPage().renamePlanTitle( "2" ).tap()
        self.navigator.addTestPlanPage().editPlanName( "iPhone 13.x 系列", "SpP Plan", "AT", "Master", "Prod", "Master" )
        self.navigator.addTestPlanPage().editConfirm().tap()
        self.navigator.addTestPlanPage().renamePlanTitle( "3" ).tap()
        self.navigator.addTestPlanPage().editPlanName( "iPhone 11.x 系列", "HighTier Plan", "AT", "Master", "Prod","Master" )
        self.navigator.addTestPlanPage().editConfirm().tap()
        self.navigator.addTestPlanPage().acceptTestCasePaln().tap()
