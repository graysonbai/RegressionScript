...
class Regression( unittest.TestCase ):
    ...
    def test_RegressionDay2_iOS(self):
        ...
        self.navigator.selectCasePage().selectCasesSubmit().tap()
        self.navigator.addTestPlanPage().renamePlanTitle( "1" ).tap()
        self.navigator.addTestPlanPage().editPlanName( "iPhone (12.4.1)", "500 Plan", "R-C", "Release", "Stg", "Release" )
        self.navigator.addTestPlanPage().editConfirm().tap()
        self.navigator.addTestPlanPage().renamePlanTitle( "2" ).tap()
        self.navigator.addTestPlanPage().editPlanName( "iPhone (11.4)", "SpP Plan", "R-C", "Release", "Stg", "Release" )
        self.navigator.addTestPlanPage().editConfirm().tap()
        self.navigator.addTestPlanPage().renamePlanTitle( "3" ).tap()
        self.navigator.addTestPlanPage().editPlanName( "iPhone (13.3.1)", "HighTier Plan", "R-C", "Release", "Stg","Release" )
        self.navigator.addTestPlanPage().editConfirm().tap()
        self.navigator.addTestPlanPage().acceptTestCasePaln().tap()
    ...
    def test_FinalCheck_iOS(self):
        ...
        self.navigator.selectCasePage().selectCasesSubmit().tap()
        self.navigator.addTestPlanPage().renamePlanTitle( "1" ).tap()
        self.navigator.addTestPlanPage().editPlanName( "iPhone (12.4.1)", "500 Plan", "AT", "Release", "Stg", "Release" )
        self.navigator.addTestPlanPage().editConfirm().tap()
        self.navigator.addTestPlanPage().renamePlanTitle( "2" ).tap()
        self.navigator.addTestPlanPage().editPlanName( "iPhone (11.4)", "SpP Plan", "AT", "Release", "Stg", "Release" )
        self.navigator.addTestPlanPage().editConfirm().tap()
        self.navigator.addTestPlanPage().renamePlanTitle( "3" ).tap()
        self.navigator.addTestPlanPage().editPlanName( "iPhone (13.3.1)", "HighTier Plan", "AT", "Release", "Stg","Release" )
        self.navigator.addTestPlanPage().editConfirm().tap()
        self.navigator.addTestPlanPage().acceptTestCasePaln().tap()
